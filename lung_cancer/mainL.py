...
train_folder = '/ChestXRay_Dataset/lung_cancer/data/dataset/train'
test_folder = '/ChestXRay_Dataset/lung_cancer/data/dataset/test'
validate_folder = '/ChestXRay_Dataset/lung_cancer/data/dataset/valid'
...
img_path = r"D:/ChestXRay_Dataset/lung_cancer/data/dataset/valid/adenocarcinoma_left.lower.lobe_T2_N0_M0_Ib\000108 (7).png"
...
# Function to load and preprocess an image for prediction
IMAGE_SIZE = (350, 350)     #target_size
...
# Define class labels (manually if train_generator isn't available)
class_labels = ['adenocarcinoma', 'large.cell.carcinoma', 'normal', 'squamous.cell.carcinoma']

# Load, preprocess, and predict the class of an image
#img_path = r"D:/ChestXRay_Dataset/lung_cancer/data/dataset/valid/adenocarcinoma_left.lower.lobe_T2_N0_M0_Ib/000108 (7).png"
img_path = r"D:/ChestXRay_Dataset/lung_cancer/data/dataset/valid/large.cell.carcinoma_left.hilum_T2_N2_M0_IIIa/000108.png"
img = load_and_preprocess_image(img_path, IMAGE_SIZE)
